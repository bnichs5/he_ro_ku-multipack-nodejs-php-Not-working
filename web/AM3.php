...
function pageDOWN () {
    ...
    document.getElementByTagName("html").dispatchEvent(simulatedEvent);
}

function pageUP () {
    var simulatedEvent2 = new KeyboardEvent("keypress", {keyCode: 33, which: 33});
    document.getElementByTagName("html").dispatchEvent(simulatedEvent2);
}
